...
async def start(bot, update):
        ...
        try:
            ...
            await update.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup([
                    [ InlineKeyboardButton(text=" 🔰JOIN OUR CHANNEL🔰 ", url=f"https://t.me/dmx_link")]
              ])
            )
            return
        except Exception:
        ...
        if file_type == "document":
            ...
            [
                ...
                [
                    ...
                    InlineKeyboardButton('‼️ 𝘾𝙃𝘼𝙉𝙉𝙀𝙇', url='https://t.me/dmx_link')
                ]
            ]
        )
    )
    ...
    buttons = [[
        ...
        InlineKeyboardButton('⭕️ 𝙅𝙊𝙄𝙉 𝙊𝙐𝙍 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 ⭕️', url ='https://t.me/dmx_link')
        ],[
