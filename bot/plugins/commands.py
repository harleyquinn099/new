...
async def start(bot, update):
        ...
        try:
            ...
            await update.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup([
                    [ InlineKeyboardButton(text=" 🔰JOIN OUR CHANNEL🔰 ", url=f"https://t.me/joinchat/oElQ06pIs8wwYzQ1")]
              ])
            )
            return
        except Exception:
        ...
        if file_type == "document":
            ...
            [
                ...
                [
                    ...
                    InlineKeyboardButton('‼️ 𝘾𝙃𝘼𝙉𝙉𝙀𝙇', url='https://t.me/joinchat/oElQ06pIs8wwYzQ1')
                ]
            ]
        )
    )
    ...
    buttons = [[
        ...
        InlineKeyboardButton('⭕️ 𝙅𝙊𝙄𝙉 𝙊𝙐𝙍 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 ⭕️', url ='https://t.me/joinchat/oElQ06pIs8wwYzQ1')
        ],[
    ...
    await bot.send_photo(
        chat_id=update.chat.id,
        photo="https://telegra.ph/file/16eeda28ca81c161ee99e.jpg",
